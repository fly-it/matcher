...
# chatgpt api key text area
api_key = st.text_area("Coller l'api key du chatgpt ici:")
...
if st.button('Comparer'):
    if job_description and resume_selected:
        ...
        with st.spinner("Analyse en cours..."):
            ...
            job_description_enhanced = f.process_job_description(job_description, api_key)
            resume_enhanced = f.process_resume(resume_text, api_key)
